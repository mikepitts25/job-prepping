...
PAGES = [
    ("00-program-brief", "1. Program &amp; Role Brief", "What EADGE-T is, what the team does, and what they are actually hiring for."),
    ("01-interview-map", "2. Interview Map &amp; 14-Day Plan", "The likely loop, what each round tests, and a day-by-day study schedule."),
    ("02-python", "3. Python Refresher", "The 20% of Python that shows up in 80% of interviews, plus idioms and testing."),
    ("03-java", "4. Java Refresher", "Collections, streams, concurrency, and modern Java features with examples."),
    ("04-dsa", "5. Data Structures &amp; Algorithms", "Complexity, the core structures, patterns, and 24 practice problems."),
    ("05-ood", "6. OO Design &amp; SOLID", "Design principles, patterns you will be asked about, and a live design exercise."),
    ("06-linux", "7. Linux / RHEL", "Shell, systemd, networking, permissions, and production troubleshooting drills."),
    ("07-git-agile", "8. Git, GitLab &amp; Agile", "Branching, baseline merges, conflict resolution, Scrum and Kanban mechanics."),
    ("08-testing-ci", "9. Testing &amp; CI/CD", "Unit tests, mocking, coverage, GitLab CI and Jenkins pipelines end to end."),
    ("09-containers", "10. Docker, Kubernetes &amp; Helm", "Images, orchestration, Helm charts, and the questions asked about each."),
    ("10-architecture", "11. Architecture &amp; Software Factory", "SOA, microservices, messaging, cloud-native, and the DevSecOps factory model."),
    ("11-cyber", "12. Cybersecurity &amp; Sustainment", "STIGs, RMF, CVE remediation, and COTS/FOSS upgrade strategy."),
    ("12-behavioral", "13. Behavioral &amp; Expat Questions", "STAR stories, LM interview style, and the UAE assignment conversation."),
    ("13-mock-interview", "14. Mock Interview Bank", "120 questions with model answers, graded by round."),
    ("14-cheatsheets", "15. Cheat Sheets", "One-page recalls for the morning of the interview."),
]
