...
PAGES = [
    ...
    ("python", "4. Python Foundations", "The language from zero: names and objects, containers, functions, classes, and why each exists."),
    ("python-practice", "5. Python in Practice", "Standard library, generators, decorators, logging, and testing with pytest from first principles."),
    ("java", "6. Java Refresher", "Collections, streams, concurrency, and modern Java features with examples."),
    ("dsa", "7. Data Structures &amp; Algorithms", "Complexity, the core structures, patterns, and 24 practice problems."),
    ("ood", "8. OO Design &amp; SOLID", "Design principles, patterns you will be asked about, and a live design exercise."),
    ("linux", "9. Linux / RHEL", "Shell, systemd, networking, permissions, and production troubleshooting drills."),
    ("git-agile", "10. Git, GitLab &amp; Agile", "Branching, baseline merges, conflict resolution, Scrum and Kanban mechanics."),
    ("testing-ci", "11. Testing &amp; CI/CD", "Unit tests, mocking, coverage, GitLab CI and Jenkins pipelines end to end."),
    ("containers", "12. Docker, Kubernetes &amp; Helm", "Images, orchestration, Helm charts, and the questions asked about each."),
    ("architecture", "13. Architecture &amp; Software Factory", "SOA, microservices, messaging, cloud-native, and the DevSecOps factory model."),
    ("cyber", "14. Cybersecurity &amp; Sustainment", "STIGs, RMF, CVE remediation, and COTS/FOSS upgrade strategy."),
    ("adoc-bridge", "15. Your ADOC Bridge", "Turning the Qatar ADOC product owner role into credible answers for a hands-on job."),
    ("behavioral", "16. Behavioral &amp; Expat Questions", "STAR stories, LM interview style, and the UAE assignment conversation."),
    ("scenarios", "17. Scenario Answers", "Sixteen worked \"what would you do if\" answers, with the follow-ups they will ask."),
    ("mock-interview", "18. Mock Interview Bank", "132 questions with model answers, graded by round."),
    ("cheatsheets", "19. Cheat Sheets", "One-page recalls for the morning of the interview."),
]
