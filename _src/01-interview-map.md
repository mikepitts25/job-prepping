# 2. Interview map and 14-day plan
...
(see [lesson 13](12-behavioral.html)).
...
- Two or three **questions for them** that only someone who read about the
  program would ask. Examples in [lesson 14](13-mock-interview.html).
...
- **Language depth questions.** Python: mutability, generators, GIL, context
  ...
  concurrency, streams, memory. See lessons 3 and 4.
- **Linux questions.** Find the file, follow the log, diagnose the full disk,
  read the process list. See [lesson 7](06-linux.html).
- **Testing and CI questions.** How do you test legacy code with no tests; what
  ...
  See [lesson 9](08-testing-ci.html).
...
**Day 1 &ndash; Orientation.** Read [lesson 1](00-program-brief.html) and this
one. Set up your environment: Python 3.11+, a JDK 17+, Git, an editor, and the
[practice repo](../practice/README.html). Rehearse the three-minute program
summary out loud once.

**Day 2 &ndash; Python core.** [Lesson 3](02-python.html) sections 1&ndash;5.
Type every example. Do practice problems P1&ndash;P4.

**Day 3 &ndash; Python idioms and testing.** Rest of lesson 3. Write pytest
tests for two of yesterday's solutions. Problems P5&ndash;P8.

**Day 4 &ndash; Java refresher.** [Lesson 4](03-java.html). Compile and run
everything. Write one class with proper `equals`, `hashCode`, and `toString`
from memory.

**Day 5 &ndash; Complexity and core structures.** [Lesson 5](04-dsa.html)
sections 1&ndash;4. Problems A1&ndash;A6, timed at 20 minutes each.

**Day 6 &ndash; Algorithm patterns.** Lesson 5 sections 5&ndash;8. Problems
A7&ndash;A14. Narrate out loud on at least three of them.

**Day 7 &ndash; OO design.** [Lesson 6](05-ood.html) end to end, including the
design exercise. Then rest. Actually rest.

### Week 2: the job-shaped material

**Day 8 &ndash; Linux and troubleshooting.** [Lesson 7](06-linux.html) plus the
drills. Do them on a real shell, not from memory.

**Day 9 &ndash; Git, GitLab, Agile.** [Lesson 8](07-git-agile.html). Do the
merge-conflict exercise for real in a scratch repo.

**Day 10 &ndash; Testing and CI/CD.** [Lesson 9](08-testing-ci.html). Write a
`.gitlab-ci.yml` for the practice repo and be able to explain each stage.

**Day 11 &ndash; Containers and architecture.** Lessons
[10](09-containers.html) and [11](10-architecture.html). Write and run a
Dockerfile for the practice service.

**Day 12 &ndash; Cyber and sustainment.** [Lesson 12](11-cyber.html). Prepare
your answer to the dependency-upgrade question, which is nearly certain to
appear in some form.

**Day 13 &ndash; Behavioral.** [Lesson 13](12-behavioral.html). Write out six
STAR stories in full. Rehearse the expat answer with someone else in the room.

**Day 14 &ndash; Mock and taper.** Work [lesson 14](13-mock-interview.html)
under time pressure. Two coding problems, timed and narrated. Then stop. Skim
[the cheat sheets](14-cheatsheets.html) the morning of, and nothing else.

## Compressed plans

**Seven days:** Days 1, 2, 3, 5, 6, 10, 13, 14 compressed into one week. Skip
lessons 10 and 11 as study; skim them for vocabulary only.

**Three days:** Day one, lesson 3 plus problems A1&ndash;A8 timed. Day two,
lesson 9 plus lesson 12's upgrade answer plus lesson 1's program summary. Day
three, lesson 13 behavioral stories written out in full, and one timed mock. If
you only have three days, behavioral and program fluency return more than
algorithms.

**One evening:** [Cheat sheets](14-cheatsheets.html), the program summary in
lesson 1, and six STAR stories from lesson 13. In that order.
